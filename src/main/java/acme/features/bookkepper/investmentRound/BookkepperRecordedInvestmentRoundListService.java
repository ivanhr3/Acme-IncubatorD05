...
@Service
public class BookkepperRecordedInvestmentRoundListService implements AbstractListService<Bookkepper, InvestmentRound> {
	...
	public Collection<InvestmentRound> findMany(final Request<InvestmentRound> request) {
		...
		Collection<InvestmentRound> result = this.repository.findManyByBookkepperRecorded(id);
		return result;
	}
