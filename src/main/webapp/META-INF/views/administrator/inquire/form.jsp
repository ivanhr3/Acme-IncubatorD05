...
<acme:form>
	...
	<acme:form-textbox code="administrator.inquire.form.label.minimumMoney" path="minimumMoney"/>
	<acme:form-textbox code="administrator.inquire.form.label.maximumMoney" path="maximumMoney"/>
